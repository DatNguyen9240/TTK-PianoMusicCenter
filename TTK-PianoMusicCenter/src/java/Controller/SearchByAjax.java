...
public class SearchByAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderCourseDTO> list = dao.getAllProductBySearch(txtSearch,0);
        PrintWriter out = response.getWriter();
        for (OrderCourseDTO o : list) {
            
            out.println("<li onclick=\"clickSearch("+"'"+o.getName()+"'"+")\" style=\"cursor: pointer\">"+o.getName()+"</li>\n" +
"");
