...
public class PaginationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int k = Integer.parseInt(request.getParameter("cnt"));
            session.setAttribute("cnt", k);
            List<OrderCourseDTO> lists = new ArrayList<>();
            if(session.getAttribute("cid")!=null){
                    lists = dao.getAllProductbyCidPage((String) session.getAttribute("cid"), (k - 1) * 6);
                    
            }else{
                    lists = dao.getAllProduct((k - 1) * 6);
            }
